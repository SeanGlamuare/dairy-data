...
const Hero = () => {
	return (
		<div className="w-full overflow-hidden h-[800px] lg:h-[600px] 2xl:h-[800px] relative">
			...
			<div className="absolute top-0 z-10 flex items-center justify-center w-full h-full px-10 text-white lg:px-20 bg-gradient-to-r from-black/50 to-black/10">
				<div className="flex flex-col max-w-5xl gap-10 2xl:max-w-7xl">
					...
					<div className="flex flex-col items-center gap-8 font-semibold lg:flex-row">
						<div className="p-2 px-8 text-sm font-semibold text-black transition-all duration-100 bg-white rounded-full cursor-pointer active:shadow-none active:scale-[.98] w-36 flex justify-center hover:shadow-lg hover:shadow-black/25">
							Contact Us
						</div>
